...
\begin{itemize}
\item Improved the CI/CD architecture in Jenkins
\item Configured the processes for automatic assembly and publication of iOS and Android applications
\item Updated the authorization process in Apple from 2FA to JWT authentication
\item Set up the infrastructure for automatic registration of applications in Google Cloud Console and Firebase
\end{itemize}
Jenkins, Gitlab CI, Python, Ruby

\divider

\cvevent{Junior Backend Developer}{Iqutor}{Apr 2022 -- Jan 2023}{}

\begin{itemize}
\item Improved the system architecture by adopting asynchronous communication
\item Set up CI/CD and project deployment
\item Improved test coverage by 20\%
...
\cvevent{Bachelor's degree,\\ Software Engineering}{ITMO University}{Sept 2021 -- June 2027}{}
